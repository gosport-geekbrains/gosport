...
class Category(models.Model):
    name = models.CharField(
        verbose_name='Категория объекта', max_length=255, unique=True)
    ...
    ya_preset = models.CharField(verbose_name='Yandex settings', max_length=255, blank=True, null=True)
...
class AdmArea(models.Model):
    name = models.CharField(
        verbose_name='Административный округ', unique=True, max_length=255)
    description = models.CharField(
        verbose_name='Описание округа', blank=True, max_length=255)
    is_active = models.BooleanField(
        verbose_name='Признак активности', default=True)
...
class District(models.Model):
    name = models.CharField(verbose_name='Район', max_length=255, unique=True)
...
class GeoObject(models.Model):
    ...
    object_name = models.CharField(
        verbose_name='Название объекта (общее)', max_length=255)
    name_winter = models.CharField(
        verbose_name='Зимнее название', max_length=255,blank=True, null=True)
    name_summer = models.CharField(
        verbose_name='Летнее название', max_length=255, blank=True, null=True)
    ...
    email = models.CharField(
        verbose_name='Адрес электронной почты для связи', max_length=255, blank=True, null=True)
    description = models.TextField(
        verbose_name='Описание объекта', blank=True, null=True)
    web_site = models.CharField(
        verbose_name='Адрес сайта', max_length=255, blank=True, null=True)
    help_phone = models.CharField(
        verbose_name='Телефон для связи', max_length=255, blank=True, null=True)
    ...
    disability_friendly = models.CharField(
        verbose_name='Приспособлено для инвалидов', max_length=255, blank=True, null=True)
    lighting = models.CharField(
        verbose_name='Освещение', max_length=5255, blank=True, null=True)
    has_light = models.BooleanField(verbose_name='Наличие освещения', default=False)
    paid = models.CharField(
        verbose_name='Платное посещение', max_length=255, blank=True, null=True)
    ...
    usage_period_winter = models.CharField(
        verbose_name='Период использования зимой', max_length=255, blank=True, null=True)
    usage_period_summer = models.CharField(verbose_name='Период использования летом', max_length=255, blank=True, null=True)
    services_winter = models.CharField(
        verbose_name='Зимние возможности', max_length=255, blank=True, null=True)
    services_summer = models.CharField(
        verbose_name='Летние возможности', max_length=255, blank=True, null=True)
    paid_comments = models.TextField(verbose_name='Информация о оплате', blank=True, null=True)
    surface_type_winter = models.CharField(
        verbose_name='Тип зимнего покрытия', max_length=255, blank=True, null=True)
    surface_type_summer = models.CharField(
        verbose_name='Тип летнего покрытия', max_length=255, blank=True, null=True)
...
class Photo(models.Model):
    ...
    photo = models.ImageField(verbose_name='Фотография', upload_to='photo', max_length=255)
    #author = 
    ...
    api_id = models.CharField(verbose_name='Идентификатор в API', max_length=100, blank=True, null=True)
    name = models.CharField(max_length=255,blank=True, null=True)


class Dataset(models.Model):
    name = models.CharField(verbose_name='Название датасета', max_length=255)
    dataset_id = models.PositiveIntegerField(
